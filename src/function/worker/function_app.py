...
def generate_tags(file_name: str) -> list:
    try:
        ...
        model_name = os.environ.get("OPENAI_MODEL", "gemini-1.5")
        ...
        response = ai_client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "Tu es un classificateur de documents. Réponds uniquement avec un tableau JSON valide de chaînes, sans autre texte."
                },
                {
                    "role": "user",
                    "content": (
                        f"Analyse le nom du fichier suivant et génère entre 3 et 8 tags courts en français.\n"
